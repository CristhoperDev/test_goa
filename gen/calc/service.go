...
type Service interface {
	...
	Multiplication(context.Context, *MultiplicationPayload) (res int, err error)
}
...
// MethodKey key.
var MethodNames = [3]string{"add", "minus", "multiplication"}
...
// MultiplicationPayload is the payload type of the calc service multiplication
// method.
