...
func ParseEndpoint(cc *grpc.ClientConn, opts ...grpc.CallOption) (goa.Endpoint, interface{}, error) {
	var (
		...
		calcMultiplicationMessageFlag = calcMultiplicationFlags.String("message", "", "")
	)
	...
	)
	{
		...
		case "calc":
			...
			case "multiplication":
				...
				data, err = calcc.BuildMultiplicationPayload(*calcMultiplicationMessageFlag)
			}
		}
	}
	if err != nil {
...
func calcMultiplicationUsage() {
	fmt.Fprintf(os.Stderr, `%s [flags] calc multiplication -message JSON

Multiplication implements multiplication.
    -message JSON: 

Example:
    `+os.Args[0]+` calc multiplication --message '{
