...
// EncodeMultiplicationResponse returns an encoder for responses returned by
// the calc multiplication endpoint.
func EncodeMultiplicationResponse(encoder func(context.Context, http.ResponseWriter) goahttp.Encoder) func(context.Context, http.ResponseWriter, interface{}) error {
	return func(ctx context.Context, w http.ResponseWriter, v interface{}) error {
		res := v.(int)
		enc := encoder(ctx, w)
		body := res
...
// DecodeMultiplicationRequest returns a decoder for requests sent to the calc
// multiplication endpoint.
func DecodeMultiplicationRequest(mux goahttp.Muxer, decoder func(*http.Request) goahttp.Decoder) func(*http.Request) (interface{}, error) {
	return func(r *http.Request) (interface{}, error) {
		var (
			a   int
			b   int
		...
		payload := NewMultiplicationPayload(a, b)
